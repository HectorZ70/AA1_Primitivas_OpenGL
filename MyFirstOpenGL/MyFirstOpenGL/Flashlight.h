...
public:
	Flashlight(const glm::vec3& color = glm::vec3(1.f, 0.95f, 0.85f),
		float innerAngleDegrees = 15.f, float outerAngleDegrees = 22.f,
		float intensity = 3.f, bool startOn = true);
